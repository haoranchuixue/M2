"""Build DSP Report dashboard - FIXED: component id must match chart view id, compact JSON."""
import sys
...
x_axis = [make_field(f) for f in all_fields]
...
chart_view = {
    ...
    "customAttr": {
        "basicStyle": {
            ...
            "tableColumnWidth": 100, "tablePageMode": "page", "tablePageSize": 20,
        ...
        "misc": {"pieInnerRadius": 0, "pieOuterRadius": 80, "radarShape": "polygon", "radarSize": 80,
                 "gaugeMinType": "fix", "gaugeMinField": {"id": "", "summary": ""}, "gaugeMin": 0,
                 "gaugeMaxType": "fix", "gaugeMaxField": {"id": "", "summary": ""}, "gaugeMax": 100,
                 "gaugeStartAngle": 225, "gaugeEndAngle": -45, "nameFontSize": 18, "valueFontSize": 18,
                 "nameValueSpace": 10, "valueFontColor": "#5470c6", "valueFontFamily": "Microsoft YaHei",
                 "valueFontIsBolder": False, "valueFontIsItalic": False, "valueLetterSpace": 0,
                 "valueFontShadow": False, "showName": True, "nameFontColor": "#000000",
                 "nameFontFamily": "Microsoft YaHei", "nameFontIsBolder": False, "nameFontIsItalic": False,
                 "nameLetterSpace": "0", "nameFontShadow": False, "treemapWidth": 80, "treemapHeight": 80,
                 "liquidMax": 100, "liquidMaxType": "fix", "liquidMaxField": {"id": "", "summary": ""},
                 "liquidSize": 80, "liquidShape": "circle", "hPosition": "center", "vPosition": "center",
        ...
        "label": {"show": False, "position": "top", "color": "#000000", "fontSize": 10, "formatter": "",
                  "labelLine": {"show": True},
        ...
        "tooltip": {"show": True, "trigger": "item", "confine": True, "fontSize": 12, "color": "#000000",
        ...
        "tableTotal": {
            "row": {"showGrandTotals": True, "showSubTotals": True, "reverseLayout": False, "reverseSubLayout": False,
                    "label": "总计", "subLabel": "小计", "subTotalsDimensions": [],
                    "calcTotals": {"aggregation": "SUM", "cfg": []}, "calcSubTotals": {"aggregation": "SUM", "cfg": []},
                    "totalSort": "none", "totalSortField": ""},
            "col": {"showGrandTotals": True, "showSubTotals": True, "reverseLayout": False, "reverseSubLayout": False,
                    "label": "总计", "subLabel": "小计", "subTotalsDimensions": [],
                    "calcTotals": {"aggregation": "SUM", "cfg": []}, "calcSubTotals": {"aggregation": "SUM", "cfg": []},
                    "totalSort": "none", "totalSortField": ""}
        },
        "tableHeader": {"indexLabel": "序号", "showIndex": False, "tableHeaderAlign": "center",
        ...
        "map": {"id": "", "level": "world"},
        "indicator": {"show": True, "fontSize": 20, "color": "#5470C6ff", "hPosition": "center", "vPosition": "center",
                      "isItalic": False, "isBolder": True, "fontFamily": "Microsoft YaHei", "letterSpace": 0,
                      "fontShadow": False, "suffixEnable": True, "suffix": "", "suffixFontSize": 14,
        ...
        "indicatorName": {"show": True, "fontSize": 18, "color": "#ffffffff", "isItalic": False, "isBolder": True,
                          "fontFamily": "Microsoft YaHei", "letterSpace": 0, "fontShadow": False, "nameValueSpacing": 0}
    },
    "customAttrMobile": None,
    "customStyle": {
        "text": {"show": True, "fontSize": "18", "hPosition": "left", "vPosition": "top", "isItalic": False,
                 "isBolder": False, "remarkShow": False, "remark": "", "fontFamily": "Microsoft YaHei",
                 "letterSpace": "0", "fontShadow": False, "color": "#111111", "remarkBackgroundColor": "#ffffff"},
        "legend": {"show": True, "hPosition": "center", "vPosition": "bottom", "orient": "horizontal",
                   "icon": "circle", "color": "#000000", "fontSize": 12},
        "xAxis": {"show": True, "position": "bottom", "name": "", "color": "#000000", "fontSize": 12,
        ...
        "yAxis": {"show": True, "position": "left", "name": "", "color": "#000000", "fontSize": 12,
                  "axisLabel": {"show": True, "color": "#000000", "fontSize": 12, "rotate": 0, "formatter": "{value}"},
                  ...
                  "axisValue": {"auto": True, "min": 10, "max": 100, "split": 10, "splitCount": 10},
                  "axisLabelFormatter": {"type": "auto", "unit": 1, "suffix": "", "decimalCount": 2, "thousandSeparator": True}},
        "yAxisExt": {"show": True, "position": "right", "name": "", "color": "#000000", "fontSize": 12,
                     "axisLabel": {"show": True, "color": "#000000", "fontSize": 12, "rotate": 0, "formatter": "{value}"},
                     "axisLine": {"show": False, "lineStyle": {"color": "#cccccc", "width": 1, "style": "solid"}},
                     "splitLine": {"show": True, "lineStyle": {"color": "#CCCCCC", "width": 1, "style": "solid"}},
                     "axisValue": {"auto": True, "min": None, "max": None, "split": None, "splitCount": None},
                     "axisLabelFormatter": {"type": "auto", "unit": 1, "suffix": "", "decimalCount": 2, "thousandSeparator": True}},
        "misc": {"showName": False, "color": "#000000", "fontSize": 12, "axisColor": "#999", "splitNumber": 5,
    ...
    "createBy": None, "createTime": None, "updateTime": None, "snapshot": None,
    ...
    "linkageActive": False, "jumpActive": False, "aggregate": None,
    "flowMapStartName": [], "flowMapEndName": [], "calParams": [], "extColor": [], "sortPriority": [],
    "data": None, "privileges": None, "isLeaf": None, "pid": None, "sql": None,
    "drill": False, "drillFilters": None, "position": None,
    "totalPage": 0, "totalItems": 0, "datasetMode": 0, "datasourceType": None,
    "chartExtRequest": None, "isExcelExport": False, "exportDatasetOriginData": False,
    "cache": False, "sourceTableId": None, "downloadType": None,
    "xAxis": x_axis, "xAxisExt": [], "yAxis": [], "yAxisExt": []
}

# FIX: Component id MUST match chart view id exactly
component = {
    "animations": [],
    ...
    "commonBackground": {
        ...
        "backgroundColor": "rgba(255, 255, 255, 1)", "innerImageColor": ""
    },
    "state": "ready",
    "render": "custom",
    "id": chart_id,  # MUST match chart view id
    "_dragId": 0,
    "show": True,
    "linkageFilters": [],
    "canvasActive": False,
...
# FIX: Use compact JSON (no spaces) so "id":"<chart_id>" matches server-side pattern
...
assert check_pattern in compact_comp, f"Pattern {check_pattern} not found in componentData!"
print(f"Component ID check: '{check_pattern}' found in componentData ✓")
print(f"ComponentData preview: {compact_comp[:200]}")
    ...
    if code == 0:
        ...
        if v_views:
            for vid, vdata in v_views.items():
                print(f"  View '{vid}': type={vdata.get('type')}, title={vdata.get('title')}, xAxis={len(vdata.get('xAxis', []))}")
            ...
            # Verify from core after publish
            verify2 = requests.post(f'{base}/de2api/dataVisualization/findById', headers=headers,
                                   json={"id": dashboard_id, "busiFlag": "dashboard", "resourceTable": "core"}, timeout=30)
            v2_views = verify2.json().get('data', {}).get('canvasViewInfo', {})
            print(f"  Views (core after publish): {len(v2_views)}")
            
            print(f"\n{'='*60}")
            print(f"Dashboard ready at: {base}/#/panel/index?dvId={dashboard_id}")
            print(f"{'='*60}")
        else:
            print("\n  WARNING: Views still empty!")
            # Debug: check componentData format
            stored_comp = v_data.get('componentData', '')
            print(f"  Stored componentData preview: {stored_comp[:200]}")
    else:
        print(f"Error: {msg}")
else:

"""Add table chart with correct field format."""
import sys
...
# Chart view with NATIVE JSON types (not strings)
chart_view = {
    "id": chart_id,
...
if r.status_code == 200:
    ...
    if code == 0:
        print("\n*** Dashboard updated with table chart! ***")
        ...
        print(f"Publish: {r2.status_code}, {r2.text[:300]}")
        
        print(f"\n*** Dashboard URL: {base}/#/panel/index ***")
        print(f"*** Direct preview: {base}/#/dvCanvas/preview/panel/{dashboard_id} ***")
else:
